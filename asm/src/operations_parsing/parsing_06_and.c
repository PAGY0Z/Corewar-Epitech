...
////////////////////////////////////////////////////////////////////////////////
/// \file parsing_06_and.c
/// \brief Contains the parsing function for the and operation.
...
////////////////////////////////////////////////////////////////////////////////
/// \brief Check if the and operation is well written and add it to the buffer.
...
bool parsing_06_and(asm_t *asm_struct, char **line)
{
    ...
    if (!my_strcmp(line[0], "and")) return false;
    if (!add_byte_to_buffer(asm_struct, 0x06)) return false;
