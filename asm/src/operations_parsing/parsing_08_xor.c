...
////////////////////////////////////////////////////////////////////////////////
/// \file parsing_08_xor.c
/// \brief Contains the parsing function for the xor operation.
...
////////////////////////////////////////////////////////////////////////////////
/// \brief Check if the xor operation is well written and add it to the buffer.
...
bool parsing_08_xor(asm_t *asm_struct, char **line)
{
    ...
    if (!my_strcmp(line[0], "xor")) return false;
    if (!add_byte_to_buffer(asm_struct, 0x08)) return false;
