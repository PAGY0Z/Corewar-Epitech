...
////////////////////////////////////////////////////////////////////////////////
/// \file check_11_sti.c
/// \brief Contains the check_11_sti functions.
...
////////////////////////////////////////////////////////////////////////////////
/// \brief The parsing byte checker for sti instruction.
...
bool check_11_sti(byte_t op_code, byte_t pars_byte, byte_t *params)
{
    ...
    if (!(IS_DIR(P3(pars_byte))) && !(IS_REG(P3(pars_byte)))) return false;
    if (IS_REG(P3(pars_byte)))
        if ((params[pos] & 0xFF) < 1 || (params[pos] & 0xFF) > REG_NUMBER)
            return false;
